    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/tables").hasAnyRole("SALE", "CUSTOMER")
                        ...
                        .requestMatchers("/ingredients/**").hasAnyRole("WAREHOUSE", "MANAGER")
                        ...
                        .requestMatchers("/dishes/**").hasRole("MANAGER")
                        .requestMatchers("/combos/**").hasRole("MANAGER")
                        .requestMatchers("/menus/active").hasAnyRole("SALE", "MANAGER")
